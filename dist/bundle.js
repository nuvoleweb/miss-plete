...
/***/ function(module, exports, __webpack_require__) {
	...
	var _jaroWinkler = __webpack_require__(300);

	var _jaroWinkler2 = _interopRequireDefault(_jaroWinkler);

	var _memoize = __webpack_require__(301);
	...
	var MissPlete = function () {
	  ...
	  _createClass(MissPlete, [{
	    ...
	    value: function renderOptions() {
	      ...
	      if (documentFragment.hasChildNodes()) {
	        ...
	        newUl.addEventListener('click', function (event) {
	          if (event.target.tagName === 'LI') {
	            _this2.selectFn(_this2.scoredOptions[_this2.highlightedIndex]);
	          }
	        });
	    ...
	    key: 'selectFn',
	    value: function selectFn(option) {
	      if (option) {
